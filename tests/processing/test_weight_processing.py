...
def test_process_weight_file_funds_and_bench(tmp_path, filetype):
    ...
    weight_processing.process_weight_file(str(input_path), str(output_path), str(dates_path))
...
def test_process_weight_file_missing_dates_csv(tmp_path):
    ...
    weight_processing.process_weight_file(str(input_path), str(output_path), str(tmp_path / "Dates.csv"))
