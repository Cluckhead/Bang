...
def app(tmp_path): # Use function-scoped tmp_path
    ...
    if not os.path.isdir(template_dir):
        raise FileNotFoundError(f"Template folder not found at expected path: {template_dir}")
    ...
    try:
        ...
        app.register_blueprint(metric_bp, url_prefix='/metric') # Correct prefix based on usage
        ...
        app.register_blueprint(attribution_bp, url_prefix='/attribution') # Correct prefix
        ...
        app.register_blueprint(generic_comparison_bp, url_prefix='/compare') # Correct prefix
